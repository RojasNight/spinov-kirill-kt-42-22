...
namespace SpinovKirillKT_42_22.Controllers
{
    ...
    public class TeachersController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<IActionResult> GetTeachers([FromQuery] string? departmentName, [FromQuery] string? degreeName, [FromQuery] string? PostName)
        {
            var teachers = await _teacherService.GetTeachersAsync(departmentName, degreeName, PostName);
            return Ok(teachers);
        }
